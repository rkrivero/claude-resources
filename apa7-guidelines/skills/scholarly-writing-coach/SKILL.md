...
description: >
  ...
  estadística cuantitativa y ciencias sociales/territoriales.
metadata:
  version: "0.1.0"
...
- Consistencia en el uso de términos: no alternar sinónimos que introducen
  ambigüedad (p. ej. "área de estudio" vs. "zona analizada" vs. "territorio
  de análisis" refiriéndose al mismo concepto)
...
**Tabla de sustituciones frecuentes en tesis académicas:**
...
|---------|-------------------|---------|
| Revisión de literatura | Pasado o pretérito perfecto | "Anselin (1995) desarrolló…" |
| Descripción del método | Pasado | "Se recolectaron 487 observaciones…" |
...
- Pasiva aceptable cuando el objeto es más importante que el actor
  ("Los shapefiles fueron reproyectados al CRS métrico correspondiente")
...
del mismo tipo.
```
Incorrecto: "Los valores de la Zona A son mayores que el sector norte"
Correcto:   "Los valores de la Zona A son mayores que los del sector norte"
```
...
**Abreviaciones:**
- Definir en primer uso: "Geographically Weighted Regression (GWR)"
- No usar abreviatura antes de definirla (p. ej. "Índice de Moran (I)" en primer uso)
...
[Explicación mecanicista: por qué podría ocurrir esto en el área de estudio]
...
inclusivo), activar también el skill `corrector-prosa-castellana` del plugin
`academic-spanish-style`. Los dos skills son complementarios: este cubre la
capa APA 7 (tiempos verbales, voz, mecánica, prosa LLM); `corrector-prosa-castellana`
cubre la capa del castellano académico (RAE, Fundéu, Martínez de Sousa).
