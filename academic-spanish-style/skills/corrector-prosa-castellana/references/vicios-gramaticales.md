...
Refleja:   "Los datos se recolectaron a partir de repositorios institucionales."
Activa:    "Recolectamos los datos de los repositorios institucionales disponibles."
```
...
2. **Conectar una afirmación general con su demostración:**
   `"El modelo confirma la hipótesis: la accesibilidad reduce la variable dependiente (β = −.38, p < .001)."`
...
"La accesibilidad fue el predictor principal, su coeficiente fue negativo,
 lo que indica que la variable dependiente cae al aumentar la distancia,
 este patrón es consistente con la teoría de localización espacial."

Segmentada con puntos:
"La accesibilidad fue el predictor principal. Su coeficiente negativo indica
 que la variable dependiente decrece con la distancia. Este patrón concuerda
 con la teoría de localización espacial."
```
...
```
Mal:  "Las unidades del área de estudio clasificadas como zona de alta densidad, superan
       el promedio."
Bien: "Las unidades del área de estudio, clasificadas como zona de alta densidad,
       superan el promedio." (las dos comas aíslan el inciso, no separan S-V)
Bien: "Las unidades del área de alta densidad superan el promedio." (sin inciso)
```
