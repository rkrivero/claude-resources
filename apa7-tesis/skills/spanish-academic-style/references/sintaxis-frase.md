...
```
Núcleo tardío (débil):
"En el contexto del análisis de regresión espacial realizado, la distancia
 al CHC resultó ser la variable más influyente."

Núcleo temprano (fuerte):
"La distancia al CHC fue la variable más influyente en la regresión espacial."
```
...
"Se estimó el modelo hedónico con 487 observaciones, todas verificadas
 manualmente contra el catastro municipal."
```
