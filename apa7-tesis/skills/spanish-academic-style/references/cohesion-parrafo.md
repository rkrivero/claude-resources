...
"La distancia al CHC resultó ser el predictor de mayor peso (β = −.38)."
"Los coeficientes del modelo SAR fueron estadísticamente significativos
 para cinco de los seis atributos de accesibilidad."
```

**Discusión:**
```
"Este resultado es consistente con / contrasta con [literatura]."
"El efecto de capitalización patrimonial es mayor en Cusco que en otros CHC
 latinoamericanos, lo que sugiere [interpretación]."
```

**Marco teórico:**
```
"[Autor, año] propone que [afirmación central de la fuente]."
"La teoría hedónica establece que [principio], lo que implica [consecuencia
 para este estudio]."
```
...
"El modelo SAR incorpora un rezago espacial. La heterocedasticidad afecta al OLS.
 Cusco tiene un mercado segmentado."

Con progresión tema-rema:
"El modelo SAR incorpora un rezago espacial [rema]. Ese rezago [tema] captura la
 dependencia que el OLS ignora [rema]. Dicha dependencia [tema] caracteriza al
 mercado segmentado de Cusco."
```
...
- **Aplícalo:** cómo se manifiesta en el caso de estudio (CHC, Cusco)
