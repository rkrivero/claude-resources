...
description: >
  ...
  reporte de resultados. Especialmente calibrado para modelos hedónicos
  espaciales con datos de precios inmobiliarios en contexto urbano.
metadata:
  version: "0.1.0"
...
**Para estudios hedónicos espaciales — verificar además:**
☐ Ámbito geográfico delimitado con coordenadas o descripción del área de estudio
☐ Período de recolección de precios especificado
☐ Fuente de los datos declarada (scraped, catastral, notarial, encuesta)
☐ Naturaleza del dato de precio: precio de oferta vs. precio de transacción
...
**Para atributos hedónicos — verificar que el texto cubra las 3 categorías:**
| Categoría | Ejemplos a verificar |
|-----------|---------------------|
| Estructurales | área, habitaciones, baños, antigüedad, piso |
| De vecindad | distancia a centros, densidad, uso de suelo |
| De accesibilidad | tiempo de viaje, GTFS, Walk Score, red vial |
