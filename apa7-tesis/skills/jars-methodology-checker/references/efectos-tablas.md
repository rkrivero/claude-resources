...
APA 7 exige reportar al menos un tamaño del efecto con IC. Para estudios
observacionales hedónicos, las opciones más adecuadas son:
...
```
La distancia al CHC explicó un 8% incremental de la varianza en los precios
...
```
Tabla X
Regresión jerárquica de precios hedónicos (n = 487)

                        Modelo 1         Modelo 2         Modelo 3
Variable              B      SE        B      SE        B      SE
──────────────────────────────────────────────────────────────────
Constante          8.12    0.45     7.84    0.41     7.63    0.39
— Bloque 1: Estructurales
Área (m²)          0.013   0.001    0.011   0.001    0.010   0.001
Antigüedad        −0.009   0.002   −0.007   0.002   −0.006   0.002
— Bloque 2: Vecindad
Densidad vial               —       0.003   0.001    0.002   0.001
Uso mixto (dummy)           —       0.187   0.052    0.165   0.050
— Bloque 3: Accesibilidad
Dist. CHC (m)               —        —       —      −0.0003  0.00005
T_transporte(min)           —        —       —      −0.012   0.003
──────────────────────────────────────────────────────────────────
R²                  .31              .43              .52
R²Δ                 —               .12              .09
...
Nota. *** p < .001. Variable dependiente: ln(precio S/). Coeficientes no
estandarizados. IC 95% disponibles como material suplementario.
```
...
Variable              B       SE       β       t        p
──────────────────────────────────────────────────────────
Área (m²)          0.013    0.001    .40     13.0    <.001
CHC (dummy)        0.342    0.058    .28      5.9    <.001
Área × CHC         0.005    0.002    .12      2.5     .013
```

Interpretar: "El efecto del área sobre el precio fue mayor para inmuebles
dentro del CHC (B = 0.018) que para los de fuera (B = 0.013)."
...
────────────────────────────────────────────────────────────────────────
Área (m²)        0.004    0.009     0.013     0.016    0.025     94
Dist. CHC (m)   −0.0008  −0.0004   −0.0002  −0.0001   0.0001    78
Antigüedad      −0.018   −0.011    −0.007   −0.003    0.002     61
────────────────────────────────────────────────────────────────────────
Nota. Sig.(%) = porcentaje de observaciones con coeficiente local
